...
public class EquipesController {
	...
	/**
	 * Methode Voir toutes les �quipes
	...
	/**
	 * Methode Voir une �quipe
	 * @return liste une �quipe
	 */
	...
	/**
	 * Methode CREATE
	 * @param information �quipe
	 * @return ajoute une �quipe
	 */
	@PostMapping("/create")
	...
	public ResponseEntity<?> addEquipe(@RequestBody Equipes equipe) {
		...
		if ((libelleEquipe == null) || (libelleEquipe.isEmpty())) {
			return ResponseEntity.status(HttpStatus.BAD_REQUEST).body("Il manque le nom de l'�quipe");
		}
